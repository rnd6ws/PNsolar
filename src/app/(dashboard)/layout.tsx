"use client"
import { Bell, Search, User, LogOut, Settings as SettingsIcon, UserCircle, Moon, Sun, ChevronDown } from 'lucide-react';
                                ...
                                {userMenuOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-56 bg-popover border border-border rounded-xl shadow-xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
                                        ...
                                        <div className="flex items-center gap-2.5 px-3 py-3 bg-muted/30 border-b border-border">
                                            ...
                                            <div>
                                                <p className="text-[13px] font-semibold text-foreground leading-tight">Hoàng Lê</p>
                                                <p className="text-[11px] text-muted-foreground">hoang@pnsolar.vn</p>
                                            </div>
                                        </div>
